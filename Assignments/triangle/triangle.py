...
def main():
    #Step 1
    side1 = float(input("Please enter one side of the triangle in inches: "))
    side2 = float(input("Please enter the second side of the triangle in inches: "))
    side3 = float(input("Please enter the third side of the triangle in inches: "))
    ...
    if if_triangle(side1,side2,side3):
        #Step 2
        tri_area = (calc_area(side1,side2,side3))

        #Step 3
        tri_peri = (calc_peri(side1,side2,side3))
